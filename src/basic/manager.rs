// use crate::board::VIRTGPU_YRES;
// use crate::drivers::VIRTGPU_XRES;
...
//
// lazy_static! {
//     pub static ref WINDOW_ID_ALLOCATOR: UPIntrFreeCell<RecycleAllocator> = unsafe {
//         let r = UPIntrFreeCell::new(RecycleAllocator::new());
//         r.exclusive_access().alloc();
//         r
//     };
// }
//
